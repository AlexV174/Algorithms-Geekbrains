# Задача 2. Отсортируйте по возрастанию методом слияния одномерный вещественный массив, заданный случайными числами на промежутке
...
def merge_sort(unsorted_array):
    ...
    array_ini = [unsorted_array]
    array_spl = split_arr(array_ini)

    while len(array_spl) > 1:
